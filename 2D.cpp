...
void translation()
{
    ...
    ABC[0][0] = ABC[0][0] + tx;// [x1+tx  yy1+ty]
    ABC[0][1] = ABC[0][1] + ty;

    ABC[1][0] = ABC[1][0] + tx;// [x2+tx  y2+ty]
    ABC[1][1] = ABC[1][1] + ty;

    ABC[2][0] = ABC[2][0] + tx;// [x3+tx  y3+ty]
    ABC[2][1] = ABC[2][1] + ty;
...
ABC[0][0]=x1*sx;// [x1*sx  yy1*sy]
ABC[0][1]=yy1*sy;

ABC[1][0]=x2*sx;// [x2*sx  y2*sy]
ABC[1][1]=y2*sy;

ABC[2][0]=x3*sx;// [x3*sx  y3*sy]
ABC[2][1]=y3*sy;
